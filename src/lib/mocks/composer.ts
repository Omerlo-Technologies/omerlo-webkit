...
export function buildContentSummary(attrs: Partial<Composer.ContentSummary> = {}): Composer.ContentSummary {
...
export function buildContentTemplate(attrs: Partial<Composer.ContentTemplate> = {}): Composer.ContentTemplate {
...
export function buildBlock(type: string = 'richtext', attrs: Partial<Composer.ContentBlock>): Composer.ContentBlock {
  switch (type) {
    case 'richtext': return buildBlockRichtext(attrs);
    default: return buildBlockRichtext(attrs);
  };
}

export function buildBlockRichtext(attrs: Partial<Composer.ContentBlockRichtext> = {}): Composer.ContentBlockRichtext {
...
export function buildBlockData(attrs: Partial<Composer.ContentBlockData> = {}) : Composer.ContentBlockData {
...
export function buildBlockHtml(attrs: Partial<Composer.ContentBlockHtml> = {}) : Composer.ContentBlockHtml {
...
export function buildBlockQuote(attrs: Partial<Composer.ContentBlockQuote> = {}) : Composer.ContentBlockQuote {
...
export function buildBlockRelatedComposer(attrs: Partial<Composer.ContentBlockRelatedContent> = {}) : Composer.ContentBlockRelatedContent {
...
export function buildBlockImage(attrs: Partial<Composer.ContentBlockImage> = {}) : Composer.ContentBlockImage {
...
export function buildBlockSlideshow(attrs: Partial<Composer.ContentBlockSlideshow> = {}) : Composer.ContentBlockSlideshow {
...
export function buildBlockVideo(attrs: Partial<Composer.ContentBlockVideo> = {}) : Composer.ContentBlockVideo {
...
export function buildProfileTypeSummary(attrs: Partial<Composer.ProfileTypeSummary> = {}): Composer.ProfileTypeSummary {
...
export function buildProfileAddress(attrs: Partial<Composer.ProfileAddress> = {}): Composer.ProfileAddress {
...
export function buildProfileContact(attrs: Partial<Composer.ProfileContact> = {}): Composer.ProfileContact {
...
export function buildPersonSummary(attrs: Partial<Composer.PersonSummary> = {}): Composer.PersonSummary {
...
export function buildProjectSummary(attrs: Partial<Composer.ProjectSummary> = {}): Composer.ProjectSummary {
...
export function buildOrganizationSummary(attrs: Partial<Composer.OrganizationSummary> = {}): Composer.OrganizationSummary {
...
export function buildOrganization(attrs: Partial<Composer.Organization> = {}): Composer.Organization {
...
export function buildEventSummary(attrs: Partial<Composer.EventSummary> = {}): Composer.EventSummary {
